 ...
 */
public class datareseller extends javax.swing.JFrame {
    ...
    public void datareseller() {
        DefaultTableModel tb = new DefaultTableModel();

        tb.addColumn("Nama Depan");
        tb.addColumn("Nama Belakang");
        tb.addColumn("Username");
        tb.addColumn("Alamat");
        jTable3.setModel(tb);

        try {
            rs = st.executeQuery("select * from reseller");
            while (rs.next()) {
                tb.addRow(new Object[]{
                    rs.getString("Nama Depan"),
                    rs.getString("Nama Belakang"),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(datareseller.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new datareseller().setVisible(true);
            }
        });
    }
